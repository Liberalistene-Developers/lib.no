...
3. **Setup Enonic sandbox** (see [Sandbox Setup Guide](docs/sandbox-setup.md)):
   ```bash
...
2. Verify vhost configuration (see [Sandbox Setup Guide](docs/sandbox-setup.md))
3. Check Enonic logs:
   ```bash
...
- **[Sandbox Setup Guide](docs/sandbox-setup.md)** - Enonic configuration
