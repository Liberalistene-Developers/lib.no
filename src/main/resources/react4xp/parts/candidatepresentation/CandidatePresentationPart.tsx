...
import {CandidatePresentationItem} from '/react4xp/common/CandidatePresentationItem/CandidatePresentationItem';
...
export const CandidatePresentationPart: React.FC<CandidatePresentationListProps> = ({
  items = [],
  highlighted = true,
  preText = ''
}) => (
