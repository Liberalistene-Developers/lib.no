...
import { BudgetCutList } from '../../main/resources/react4xp/components/parts/budgetcutlist/BudgetCutList';
...
const sampleDepartment = {
  ...
  cuts: [
    ...
    },
    {
      ...
      percent: 30.9,
      description:
        '<p>Videreføring av byggeprosjekter beholdes inntil disse er ferdige. Kongelige eiendommer kan vedlikeholdes via Kongens apanasje.</p>'
    },
    {
      name: 'Samiske formål',
      budget: 531,
...
export const Normal: Story = {
  args: {
    ...
    labelSumCut: 'Totalt kutt',
    labelBudget: 'Budsjett',
    labelTitle: 'Departement',
    labelPercent: 'Prosent',
    labelCut: 'Kutt',
